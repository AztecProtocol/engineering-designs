...
For a system as the ours, even with the addition of the [based fallback mechanism](8404-based-fallback.md), there is a variety of methods a censor can use to keep a transaction out.
